...
class UserTest < ActiveSupport::TestCase
  ...
  def setup
    @user = User.new(name: "Exemple User", email: "user@exemple.com", password: "foobar", password_confirmation: "foobar")
  end
  ...
  test "email validation should accept valid addresses" do
    ...
    valid_addresses.each do |valid_address|
      ...
      assert @user.valid?, "#{valid_address} sould be valid"
    end
  end
  ...
  test "password shoube be present (nonblank)" do
